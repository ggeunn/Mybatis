...
public class Application {
    ...
    private static void trimSubMenu() {
        ...
        do{
            ...
            System.out.println(" 2. 메뉴 혹은 카테고리 코드로 검색, 단 메뉴와 카테고리 둘 다 일치하는 경우도 검색하며, 검색 조건이 없는 경우 전체 검색");
    ...
    private static Map<String ,Object> inputSearchCriteriaMap() {
        ...
        if("category".equals(condition)){
            ...
            String nameValue = sc.nextLine();
            System.out.println("검색할 카테코리 코드를 입력하세요 : ");
            int categoryValue = sc.nextInt();
    ...
    private static List<Integer> createRandomMenuCodeList() {
        ...
        while (set.size() < 5){
            /* 현재 내 데이터베이스에서 메뉴번호는 1~25 번까지 이다 */
